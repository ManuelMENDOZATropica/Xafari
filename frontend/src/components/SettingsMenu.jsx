...
export default function SettingsMenu() {
  ...
  return (
    <div className="pointer-events-none fixed right-4 top-4 z-50 flex flex-col items-end pt-12">
      <div className="pointer-events-auto relative" ref={containerRef}>
        <button
          type="button"
          onClick={toggleMenu}
          className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-sky-500 via-blue-500 to-indigo-600 text-white shadow-lg transition hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-300 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
          aria-haspopup="true"
        ...
        {isOpen && (
          <div className="absolute right-0 mt-3 w-72 max-w-[90vw]">
            <div className="rounded-3xl border border-white/40 bg-gradient-to-br from-sky-500 via-blue-500 to-indigo-600 p-[1px] shadow-2xl">
              <div className="rounded-[calc(1.5rem-2px)] bg-white/95 p-5 shadow-inner backdrop-blur-xl">
                ...
                <div className="space-y-4">
                  <section aria-label={t("settingsLanguageTitle")}
                    className="space-y-2"
                  >
                        ...
                        return (
                          <button
                            ...
                            className={`flex flex-col items-center justify-center gap-1 rounded-2xl border text-xs font-semibold uppercase transition focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
                              isActive
                                ? "border-sky-400 bg-sky-100 text-sky-700 shadow"
                                : "border-transparent bg-white/70 text-sky-600 shadow-sm hover:bg-white"
                            }`}
                        ...
                        return (
                          <button
                            ...
                            className={`flex w-full items-center justify-between rounded-2xl border px-3 py-2 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-sky-400 focus-visible:ring-offset-2 focus-visible:ring-offset-white ${
                              isActive
                                ? "border-sky-400 bg-sky-100 text-sky-800 shadow"
                                : "border-transparent bg-white/70 text-sky-700 shadow-sm hover:bg-white"
                            }`}
                            role="radio"
                  ...
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-400 to-orange-500 px-4 py-2 text-sm font-semibold text-white shadow-lg transition hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-amber-400 focus-visible:ring-offset-white"
                  >
                    <svg
                      aria-hidden="true"
                      className="h-5 w-5"
