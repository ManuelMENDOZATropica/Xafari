...
export default function LanguageToggle({ className = "" }) {
  ...
  const buttonClasses = `flex items-center justify-center w-14 h-14 sm:w-[60px] sm:h-[60px] p-0 border-none bg-transparent hover:opacity-90 active:scale-95 transition-transform ${className}`;
    ...
    <div ref={toggleRef} className="relative inline-block text-left">
      ...
      >
        <img
          ...
          alt={t("language")}
          className="w-14 h-14 sm:w-[60px] sm:h-[60px] object-cover block"
          aria-hidden={true}
        />
